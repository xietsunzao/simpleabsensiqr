                    ...
                    <?php echo form_open("auth/create_user", 'class="bs-example form-horizontal"');?>
                          ...
                          <div class="form-group">
                            <label for="inputName" class="col-md-3 control-label">Perusahaan</label>
                                <div class="col-md-7"> <?php echo form_input($company, null, 'class="form-control"readonly');?></div>
                          </div>
                        </fieldset>
                  </div>
                </div>
                    ...
                    <!-- <div class="form-group">
                      <label for="inputName" class="col-md-3 control-label">Status</label>
                          <div class="col-md-7">  <label>
                               <input type="radio" name="active" class="minimal" value="1"> Aktif
                            </label>
                            <label>
                                <input  type="radio" name="active" class="minimal" value="0"> Tidak Aktif
                            </label> </div>
                    </div> -->
